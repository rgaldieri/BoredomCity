...
public static class MeshUtils {
    ...
    public static void AddCirclePoint(Mesh mesh, Vector3 pointB, float width, int sides) {
        AddCirclePoint(mesh, pointB, normal2D, width, sides );
    }

     public static void AddCirclePoint(Mesh mesh, Vector3 pointB, Vector3 normal, float width, int sides) {
        ...
        AddCirclePoint(mesh, pointB, dirAToB, normal, width,sides);
    }

    public static void AddCirclePoint(Mesh mesh, Vector3 pointB, Vector3 pointBforward, Vector3 normal, float width, int sides) {
        Vector3[] vertices = new Vector3[mesh.vertices.Length + sides]; // Add 2 more for pointB Left/Right
        Vector2[] uv = new Vector2[mesh.uv.Length + sides];
        int[] triangles = new int[mesh.triangles.Length + sides+4];
